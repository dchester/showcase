exports.initialize = function(app) {
	...
	var apiCache = function(req, res, next) {

		var cache = require('./api-cache');
		var response = cache.get(req.url);
